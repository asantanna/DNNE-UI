...
#### Architecture & Design
- **`dnne_docs/architecture`** - Various documents describing the architecture and special issues in DNNE
...
cat dnne_docs/for_claude/tasks/INDEX.md

# View specific component tasks
cat dnne_docs/for_claude/tasks/{component}/TASKS.md

# Create new task file from template
cp dnne_docs/for_claude/tasks/TEMPLATE.md dnne_docs/for_claude/tasks/{new_component}/TASKS.md
```
