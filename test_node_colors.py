...
from custom_nodes.utility_nodes.balancing_node import BalancingNode
from custom_nodes.utility_nodes.balancing_config import BalancingConfig
...
test_nodes = [
    ...
    ("Balancing Nodes", [BalancingNode, BalancingConfig]),
...
print("  Balancing nodes: COLOR=#323       BGCOLOR=#535      (Purple)")
