...
class GetBatchNode(RoboticsNodeBase):
    ...
    OUTPUT_DICT = {
        0: {"type": "BATCH_IMAGE_TENSOR", "name": "images"},
        1: {"type": "BATCH_LABEL_TENSOR", "name": "labels"},
        2: {"type": "BOOLEAN", "name": "epoch_complete"},
        3: {"type": "BATCH_EPOCH_STATS_PYDICT", "name": "epoch_stats"}
    }
