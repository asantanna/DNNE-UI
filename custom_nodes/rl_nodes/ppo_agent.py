...
class PPOAgentNode:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "observations": ("TENSOR",),
                "hidden_sizes": ("STRING", {"default": "64,64"}),
                "activation": (["relu", "tanh", "elu"], {"default": "elu"}),
                "action_space": (["continuous", "discrete"], {"default": "continuous"}),
                "action_dim": ("INT", {"default": 1, "min": 1, "max": 10}),
                "learning_rate": ("FLOAT", {"default": 3e-4, "min": 1e-6, "max": 1e-1, "step": 1e-6}),
            },
            "optional": {
                "deterministic": ("BOOLEAN", {"default": False}),
                "init_log_std": ("FLOAT", {"default": 0.0, "min": -3.0, "max": 3.0, "step": 0.1}),
            }
        }
    ...
    def forward(self, observations, hidden_sizes="64,64", activation="elu", 
        ...
        Args:
            ...
            ... (other parameters are widget values)
