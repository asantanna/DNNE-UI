...
class TestClientManager:
    ...
    async def start_test_client(self) -> bool:
        ...
        client_script = Path(__file__).parent.parent.parent.parent / "dnne_agent" / "dnne_agent_client.py"
...
class DeploymentHelper:
    ...
    def export_workflow_locally(workflow_name: str) -> Optional[Dict[str, str]]:
        ...
        export_script = Path("/home/asantanna/DNNE/DNNE-UI/dnne_test_suite/utilities/programmatic_export.py")
