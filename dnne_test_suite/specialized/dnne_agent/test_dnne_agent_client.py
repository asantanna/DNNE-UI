...
# Add dnne_agent directory to path
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent / "dnne_agent"))
...
class TestDNNEAgentClient:
    ...
    def find_dnne_agent_client_process(self):
        ...
        for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
            try:
                ...
                # Look specifically for dnne_agent/dnne_agent_client.py to avoid matching the test script
                if cmdline and any('dnne_agent/dnne_agent_client.py' in arg for arg in cmdline):
                    return proc
    ...
    def ensure_dnne_agent_client_running(self):
        ...
        client_path = Path(__file__).parent.parent.parent.parent / "dnne_agent" / "dnne_agent_client.py"
