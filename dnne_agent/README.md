...
- **Server**: `dnne_server.log` (in dnne_agent directory)
...
The dnne_agent includes comprehensive test scripts for validating functionality.
...
### Integration with dnne_test

Future integration:
```bash
# Run all agent tests
./dnne_test dnne_agent

# Run specific test category
./dnne_test dnne_agent connectivity
./dnne_test dnne_agent telemetry
./dnne_test dnne_agent workflow
```
