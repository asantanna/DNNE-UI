...
Metadata: {
  "export_time": "2025-06-26 06:17:16",
  "workflow_id": "2",
...
class LinearLayerNode_10(QueueNode):
    ...
    def __init__(self, node_id: str):
        ...
        self.dropout = nn.Dropout(0.0) if 0.0 > 0 else None
...
class GetBatchNode_15(QueueNode):
...
class SGDOptimizerNode_20(QueueNode):
    """SGD Optimizer node"""
...
class TrainingStepNode_21(QueueNode):
...
async def main():
    ...
    # Create nodes
    node_10 = LinearLayerNode_10("10")
    node_11 = LossNode_11("11")
    node_13 = MNISTDatasetNode_13("13")
    node_14 = MNISTDatasetNode_14("14")
    node_15 = GetBatchNode_15("15")
    node_16 = LinearLayerNode_16("16")
    node_20 = SGDOptimizerNode_20("20")
    node_21 = TrainingStepNode_21("21")

    # Create runner
    runner = GraphRunner()

    # Add nodes to runner
    runner.add_node(node_10)
    runner.add_node(node_11)
    runner.add_node(node_13)
    runner.add_node(node_14)
    runner.add_node(node_15)
    runner.add_node(node_16)
    runner.add_node(node_20)
    runner.add_node(node_21)
