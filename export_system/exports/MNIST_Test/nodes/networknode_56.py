...
class NetworkNode_56(QueueNode):
    ...
    def __init__(self, node_id: str):
        ...
        # Build network from detected layers: [{'node_id': '42', 'output_size': 128, 'bias': True, 'activation': 'relu', 'dropout': 0.5, 'input_size': 784}, {'node_id': '43', 'output_size': 128, 'bias': True, 'activation': 'relu', 'dropout': 0.5, 'input_size': 128}, {'node_id': '46', 'output_size': 10, 'bias': True, 'activation': 'none', 'dropout': 0, 'input_size': 128}]
        layers = []
        ...
        self.checkpoint_trigger_value = "50"
        self.checkpoint_load_on_start = False
