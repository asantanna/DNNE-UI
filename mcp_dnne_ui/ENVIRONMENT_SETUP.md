...
### Check MCP_PY310 is ready:
```bash
source /home/asantanna/miniconda/bin/activate MCP_PY310
python -c "import mcp.server; from playwright.async_api import async_playwright; print('✅ MCP_PY310 ready')"
```

### Check DNNE_PY38 is ready:
```bash
source /home/asantanna/miniconda/bin/activate DNNE_PY38
python -c "import torch; import isaacgym; print('✅ DNNE_PY38 ready')"
```